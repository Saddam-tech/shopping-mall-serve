...
const config = require('../configs/dbconfig-streamer.json')[env]; // ./apiServe // __dirname
// const config = require('../configs/dbconfig-tickers.json')[env]; // ./apiServe // __dirname
// let config
const db = {};
...
//        acquire: 90000, // 10000 , // 60000,
        acquire: 1000000 , // 6000, // 10000 , // 60000,
//        idle: 1000, // 10000,
        idle: 4000, // 10000,
      },
    }
