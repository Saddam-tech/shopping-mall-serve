...
const { calculatedivrate_globalrounds } = require('../schedule/calculateDividendRate-globalrounds');
module.exports = (io, socket) => {
  socket.on('dividendrate_0913', async (data) => {    // console.log(    //   '@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@',    //   socket.id,    //   'ON'    // );
    let { assetList, min , nettype } = data;
		let jroundprestats = await calculatedivrate_globalrounds ( nettype ) 
    socket.emit('dividendrate_0913', jroundprestats );       
  } )
}
